...
function setup() {
    ...
    markerHiro.addChild(new AFrameP5AR.Sphere({
        x: 0, y: 0.5, z: 0,
    ...
    staticContainer3 = new AFrameP5AR.Container3D({
        x: 2, y: 0, z: -5
    });
    ...
    staticContainer3.addChild(new AFrameP5AR.Box({
        x: 0, y: 0, z: 0,
        asset: 'stonebrick',
