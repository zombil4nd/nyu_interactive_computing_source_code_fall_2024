...
// global flag to keep track of whether we should track new AFrameP5AR.markers
...
function setup() {
    ...
    let painting1 = new AFrameP5AR.Plane({
        x: 0, y: 0, z: -1,
        width: 5, height: 3,
        rotationX: -90,
        asset: 'painting1'
    ...
    let painting2 = new AFrameP5AR.Plane({
        x: 0, y: 0, z: -1,
        width: 5, height: 3,
        rotationX: -90,
        asset: 'painting2'
    });
    kanjiMarker.addChild(painting2);
}
