...
function setup() {
    ...
    let plane = new AFrameP5AR.Plane({
        x: -0.5,
        y: 0.1,
        z: 0,
        width: 0.2,
    ...
    let sphere = new AFrameP5AR.Sphere({
        x: -0.5,
        y: 0.1,
        z: 0.5,
        radius: 0.1,
    ...
    let circle = new AFrameP5AR.Circle({
        x: 0,
        y: 0.1,
        z: -0.5,
        radius: 0.1,
    ...
    let cylinder = new AFrameP5AR.Cylinder({
        x: 0,
        y: 0.1,
        z: 0.5,
        radius: 0.1,
    ...
    let dodecahedron = new AFrameP5AR.Dodecahedron({
        x: 0.5,
        y: 0.1,
        z: -0.5,
        radius: 0.1,
    ...
    let octahedron = new AFrameP5AR.Octahedron({
        x: 0.5,
        y: 0.1,
        z: 0,
        radius: 0.1,
    ...
    let tetrahedron = new AFrameP5AR.Tetrahedron({
        x: 0.5,
        y: 0.1,
        z: 0.5,
        radius: 0.1,
