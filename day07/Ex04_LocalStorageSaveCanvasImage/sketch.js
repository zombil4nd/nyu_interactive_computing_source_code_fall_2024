...
function setup() {
    // important! ensure that we are drawing 1 pixel of data per screen pixel
    // this prevents issues from arising from very dense displays, such as a Mac Retina display
    pixelDensity(1);
